            ...
            <form action="<?= base_url('dashboard/addbarang'); ?>" method="post">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="harga" id="formGroupExampleInput2" required>
                    </div>
                    <div class="mb-3">
                        <label for="formGroupExampleInput2" class="form-label">Stok</label>
                        <input type="number" class="form-control" name="stok" id="formGroupExampleInput2" required>
                    </div>
                    <div class="mb-3">
                        <label for="formGroupExampleInput2" class="form-label">Supplier</label>
                        <div>
                            <select class="form-select form-control" name="idSupplier" required>
